...
@implementation upgrade_special_handler
...
+(void)InitializeUpgrades:(UIScrollView*)view ID:(int)ID yVal:(double)y{
    ...
    back.image = [UIImage imageNamed:@"upgradeBarSpecial"];
    ...
    NSString *upgradeValue = [NSString stringWithFormat:@"CurrentValueSpecial%i", ID];
    ...
    [add_upgrade_special addUpgrade:ID upgradeImage:upgradeImage upgradeText:infoText];
    [add_upgrade_special fetchMoneyValue:ID moneyTextBox:moneyText];
...
+(void)buttonAction:(id)sender{
    ...
    [add_upgrade_special fetchMoneyValue:newID moneyTextBox:moneyText];
    ...
    if(moneyVal >= unlockVal){
        ...
        NSString *upgradeValue = [NSString stringWithFormat:@"CurrentValueSpecial%li",newID];
        ...
        [add_upgrade_special fetchMoneyValue:newID moneyTextBox:moneyText];
        [add_upgrade_special upgradeActions:newID];
